...
Then(/^I should be on the (Manage Securities|Securities Requests|Securities Release|Safekeep Securities|Pledge Securities|Transfer to Pledged|Transfer to Safekept|Transfer Securities|Manage Letters of Credit|New Letter of Credit Request|Preview Letter of Credit Request|Letter of Credit Request Success|Add Beneficiary Request|Manage Mortgage Collateral Updates|Mortgage Collateral Update Status) page$/i) do |page_type|
  text = case page_type
  ...
  when /\AManage Mortgage Collateral Updates\z/i
    I18n.t('mortgages.manage.title')
  when /\AMortgage Collateral Update Status\z/i
    I18n.t('mortgages.view.title')
  end
