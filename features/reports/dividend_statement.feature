...
@smoke @jira-mem-264
Scenario: Member sorts the Dividend Transaction Statement by certificate sequence
  Given I am on the "Dividend Transaction Statement" report page
...
@smoke @jira-mem-264
Scenario: Member sorts the Dividend Transaction Statement by start date
  Given I am on the "Dividend Transaction Statement" report page
...
@smoke @jira-mem-264
Scenario: Member sorts the Dividend Transaction Statement by end date
  Given I am on the "Dividend Transaction Statement" report page
...
@smoke @jira-mem-264
Scenario: Member sorts the Dividend Transaction Statement by shares outstanding
  Given I am on the "Dividend Transaction Statement" report page
...
@smoke @jira-mem-264
Scenario: Member sorts the Dividend Transaction Statement by days outstanding
  Given I am on the "Dividend Transaction Statement" report page
...
@smoke @jira-mem-264
Scenario: Member sorts the Dividend Transaction Statement by average shares outstanding
  Given I am on the "Dividend Transaction Statement" report page
...
@smoke @jira-mem-264
Scenario: Member sorts the Dividend Transaction Statement by dividend
  Given I am on the "Dividend Transaction Statement" report page
