...
describe("other pages", () => {
  ...
  describe("hamburger menu", () => {
    it("expands to show menu contents", () => {
      ...
      cy.get("nav.Menu-root.Menu-open")
        .should("be.visible")
        .within(() => {
          ...
          cy.get("a")
            .contains("My Teams")
            .should("have.attr", "href", "//local.lunch.pink:3000/teams");
          cy.get("a")
            .contains("Account")
            .should("have.attr", "href", "//local.lunch.pink:3000/account");
          cy.get("a")
            .contains("Log Out")
            .should("have.attr", "href", "//local.lunch.pink:3000/logout");
        });
    });
  });
  ...
  describe("Account page", () => {
    it('should have "Name," "Email," and "Change Password?" inputs and Submit button', () => {
      ...
      cy.get("label")
        .contains("Name")
        .should("have.attr", "for", "account-name");
