$(function(){
  ...
  $('select').on('change', function(event){
    ...
    if ($target.attr('name') !== 'historical_price_collateral_type' && ($target.attr('name') !== 'historical_price_credit_type' || $.inArray($target.val(), ['frc', '1m_libor', '3m_libor', '6m_libor', 'daily_prime']) > -1)) {
