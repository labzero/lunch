...
RSpec.describe AdvancesController, :type => :controller do
  ...
  describe 'GET manage_advances' do
    ...
    let(:column_headings) { [I18n.t('common_table_headings.trade_date'), I18n.t('common_table_headings.funding_date'), I18n.t('common_table_headings.maturity_date'), I18n.t('common_table_headings.advance_number'), I18n.t('common_table_headings.advance_type'), I18n.t('advances.status'), I18n.t('advances.rate'), I18n.t('common_table_headings.current_par') + ' ($)'] }
