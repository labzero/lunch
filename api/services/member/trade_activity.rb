  ...
  module Services
    module Member
      module TradeActivity
        ...
        TODAYS_CREDIT_KEYS = %w(instrumentType status terminationPar tradeDate fundingDate maturityDate tradeID amount rate productDescription terminationFee terminationFullPartial product subProduct terminationDate lifeCycleEvent)
