          ...
          if app.settings.environment == :production
            cap_stock_member_details_query = <<-SQL
              SELECT
                ...
                NVL(MPF_UNPAID_BALANCE,0) MPF_UNPAID_BALANCE,
...

            {
              ...
              mav_stock_requirement: (mav_stock_requirement.to_i if mav_stock_requirement),
              required_by_mpf: (required_by_mpf.to_i if required_by_mpf),
              required_by_advances: (required_by_advances.to_i if required_by_advances)
