module MAPI
  module Models
    class ActiveAdvances
      ...
      swagger_model :AllAdvances do
        key :required, [:trade_date, :funding_date, :maturity_date, :advance_number, :advance_type, :advance_confirmation]
        property :trade_date do
          key :type, :string
          key :format, :'date-time'
          key :description, 'Advances Trade DateTime'
        ...
        property :original_par do
          key :type, :Numeric
          key :description, 'Advances original par'
        end
        property :trade_time do
          key :type, :string
          key :description, 'The time an advance was traded.'
