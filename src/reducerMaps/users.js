...
export default new Map([
  [ActionTypes.INVALIDATE_USERS, state => update(state, {
    $merge: {
      didInvalidate: true
    }
  })
  ],
  [ActionTypes.REQUEST_USERS, state => update(state, {
    $merge: {
      isFetching: true
    }
  })
  ],
  [ActionTypes.RECEIVE_USERS, (state, action) => update(state, {
    $merge: {
      isFetching: false,
      didInvalidate: false,
  ...
  [ActionTypes.USER_DELETED, (state, action) => update(state, {
    isFetching: {
      $set: false
    },
    items: {
  ...
  [ActionTypes.USER_POSTED, (state, action) => update(state, {
    items: {
      result: {
        $push: [action.user.id]
      },
  ...
  [ActionTypes.USER_PATCHED, (state, action) => update(state, {
    isFetching: {
      $set: false
    },
    items: {
