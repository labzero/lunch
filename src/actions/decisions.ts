...
export function fetchDecisions(): ThunkAction<
  Promise<Action>,
  State,
  unknown,
  Action
...
export const decide =
  (
    restaurantId: number,
    daysAgo?: number
  ): ThunkAction<Promise<Decision>, State, unknown, Action> =>
  (dispatch) => {
...
export const removeDecision =
  (): ThunkAction<Promise<void>, State, unknown, Action> => (dispatch) => {
